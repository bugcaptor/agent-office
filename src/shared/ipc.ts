...
export const Commands = {
  ...
  runRecipeStart: "run_recipe_start",
  runRecipeStatus: "run_recipe_status",
  runRecipeStop: "run_recipe_stop",
  ...
  // 자동화 점검(kbm) — 탭 단위 LLM CLI 왕복 확인의 시작/중단/상태/타임아웃 결정.
  automationStart: "automation_start",
  automationStop: "automation_stop",
  automationStatus: "automation_status",
  automationDecide: "automation_decide",
  automationClearUncommitted: "automation_clear_uncommitted",
  automationDefinitionsList: "automation_definitions_list",
  automationDefinitionsSave: "automation_definitions_save",
  automationDefinitionsDelete: "automation_definitions_delete",
  automationDefinitionsImport: "automation_definitions_import",
  automationDefinitionsExport: "automation_definitions_export",
  automationRunStart: "automation_run_start",
  automationRunsList: "automation_runs_list",
  automationCliTransitionPreview: "automation_cli_transition_preview",
  automationAgyModels: "automation_agy_models",
  automationCliModels: "automation_cli_models",
